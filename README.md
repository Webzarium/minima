...
- Если вы участвовали в тестнете и не следили за проектом, то сокрее всего вы не проходили верефикаци и не делали запрос монет.
- Командой было выделено полгода для решения всех проблем связанный с получениекм наград.
- Как вы отнеслись к проекту, такой результат и получили.
- Поезд никого не ждёт ))

![animation](https://github.com/Webzarium/minima/assets/122037228/d179d57d-d10b-4376-836e-a93a3c243334)


https://github.com/Webzarium/minima/assets/122037228/936cf93f-b380-410b-87ab-ebabe10c83ec
