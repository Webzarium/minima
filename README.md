...
## WMINIMA и MINIMA
-  WMINIMA  обёрнутый токен MINIMA в сети Эфираи
...
- При этом вполне возможно, что сам завернутый токен может найти применение в некоторых партнерских проектах, над которыми мы работаем. Хотя на данный момент я не могу сказать большего.
